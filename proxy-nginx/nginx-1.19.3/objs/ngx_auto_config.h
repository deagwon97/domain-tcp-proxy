#define NGX_CONFIGURE " --prefix=/opt/nginx --with-ld-opt=-Wl,-rpath,/usr/lib/x86_64-linux-gnu --add-module=/workdir/proxy-nginx/ngx_devel_kit-0.3.2 --add-module=/workdir/proxy-nginx/lua-nginx-module-0.10.25"
